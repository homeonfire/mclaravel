    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('import.own-stock.process') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">
                            Загрузка файла "Наш склад" (.xlsx)
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            Данные будут взяты со **второго листа** файла. Баркод из колонки **L**, количество из колонки **I**.
                        </p>
            ...
            <div id="logs" class="mt-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('import.own-stock.show') }}" class="text-sm text-blue-500 hover:underline">Обновить лог</a>
                </div>
                @if($logs->isEmpty())
